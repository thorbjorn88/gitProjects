...
\begin{figure}
	\begin{center}
		...
		\draw (2,-1) -- (4,-1) node[pos = 0.5,below,scale=0.7] {Up-chirp Freq.};
		\draw (5,2) -- (7,2) node[pos = 0.5,above,scale=0.7] {Doppler Freq.};
		\draw (8,4) -- (10,4) node[pos = 0.5,above,scale=0.7] {Up-chirp Freq.};
